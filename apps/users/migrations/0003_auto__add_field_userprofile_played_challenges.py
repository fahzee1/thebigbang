...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.played_challenges'
        db.add_column(u'users_userprofile', 'played_challenges',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.played_challenges'
        db.delete_column(u'users_userprofile', 'played_challenges')
    ...
    models = {
        ...
        u'users.friends': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
