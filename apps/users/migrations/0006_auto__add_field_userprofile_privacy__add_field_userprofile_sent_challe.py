...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.sent_challenges'
        db.add_column(u'users_userprofile', 'sent_challenges',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.sent_challenges'
        db.delete_column(u'users_userprofile', 'sent_challenges')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
