...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.challenge_media'
        db.delete_column(u'challenges_challenge', 'challenge_media')


    def backwards(self, orm):
        # Adding field 'Challenge.challenge_media'
        db.add_column(u'challenges_challenge', 'challenge_media',
