...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.media_data'
        db.add_column(u'challenges_challenge', 'media_data',
                      self.gf('django.db.models.fields.BinaryField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.media_data'
        db.delete_column(u'challenges_challenge', 'media_data')
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'challenge_media': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100'}),
            'challenge_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'hint': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_data': ('django.db.models.fields.BinaryField', [], {'default': "''"}),
