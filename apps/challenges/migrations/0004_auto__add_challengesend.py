...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'challenges_challengesend', (
            ...
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 12, 0, 0), auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
