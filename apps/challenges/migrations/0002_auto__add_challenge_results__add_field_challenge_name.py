...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Challenge_Results'
        db.create_table(u'challenges_challenge_results', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 11, 0, 0), auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'challenges', ['Challenge_Results'])

        # Adding field 'Challenge.name'
        db.add_column(u'challenges_challenge', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Challenge_Results'
        db.delete_table(u'challenges_challenge_results')

        # Deleting field 'Challenge.name'
        db.delete_column(u'challenges_challenge', 'name')
    ...
    models = {
        ...
        u'challenges.challenge': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'challenges.challenge_results': {
            'Meta': {'object_name': 'Challenge_Results'},
